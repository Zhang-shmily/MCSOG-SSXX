...
[![答题<青海>](https://pub.idqqimg.com/wpa/images/group.png "答题<青海>")](https://qm.qq.com/cgi-bin/qm/qr?k=owz95PEgWV5fXwadBOeGr5JCtTjMT1Gb&jump_from=webapi)
...
使用UID方式绑定：<span style="color: chartreuse;">四史绑定</span> <span style="color: cyan;">UID</span>

使用Code方式绑定：<span style="color: chartreuse;">四史绑定</span> <span style="color: cyan;">Code</span>

使用Token方式绑定：<span style="color: chartreuse;">四史绑定</span> <span style="color: cyan;">Token</span>
...
无新ID：<span style="color: chartreuse;">我被封了</span>

有新ID：<span style="color: chartreuse;">我被封了</span> <span style="color: cyan;">新UID</span>
